    ...
    def get_rap_field(self, codes: list):
        ...
        **Returns**
        ...
        if not os.path.isfile('field_lookup.json'):
            print('Error: field_lookup.json not found... Try running:\n curl -L -o field_lookup.json "https://raw.githubusercontent.com/adamelkholyy/ukbython/main/field_lookup.json", shell=True, check=True')
            return
