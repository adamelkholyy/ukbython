...
```python
import subprocess
subprocess.run(f"curl -L -o cluster_ukbython.py https://raw.githubusercontent.com/adamelkholyy/ukbython/main/cluster_ukbython.py", shell=True, check=True)
